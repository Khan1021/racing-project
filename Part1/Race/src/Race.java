...
public class Race
{
    ...
    public void startRace()
    {
        ...
        while (!finished)
        {
            ...
            //adding the case where all horses fall
    ...
    private void moveHorse(Horse theHorse)
    {
        ...
        if  (!theHorse.hasFallen())
        {
            ...
            {
                theHorse.fall();
                System.out.println(theHorse.getName() + " has fallen!"); // TEMPORARY
            }//END if
        }//END if
    ...
    private void printLane(Horse theHorse)
    {
        ...
        //display horse's name and confidence outside the track
